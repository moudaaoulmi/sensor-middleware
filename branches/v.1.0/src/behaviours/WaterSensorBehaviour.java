...
public class WaterSensorBehaviour extends CyclicBehaviour
{
			...
			switch (msg.getPerformative()) 
            {
               case (ACLMessage.INFORM ):
               {
            	   if ( action instanceof InterpretData )
            	   {
            		   ...
            		   // sensor type.
            		   WaterSensor sensor = (WaterSensor)((InterpretData) action).getSensor();
	...
	protected boolean isDataValid( WaterSensor sensor )
	{
...
//			return false;
	...
	protected void handleSensorData(WaterSensor sensor)
	{
		//validate data
		SensorAgent sa = (SensorAgent)myAgent;
