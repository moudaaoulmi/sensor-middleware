...
public class HumanMovementSensorBehaviour extends CyclicBehaviour
{
			...
			switch (msg.getPerformative()) 
            {
               case (ACLMessage.INFORM ):
               {
            	   if ( action instanceof InterpretData )
            	   {
            		   ...
            		   // sensor type.
            		   HumanMovementSensor sensor = (HumanMovementSensor)((InterpretData) action).getSensor();
	...
	protected boolean isDataValid( HumanMovementSensor sensor )
	{
...
//			return false;
	...
	protected String interpretData( HumanMovementSensor sensor )
	{
		if ( sensor.getValue() ==  0 )
			return "nu exista miscare";
		else
			return "miscare detectata";
	}

	protected void handleSensorData(HumanMovementSensor sensor)
	{
		//validate data
		SensorAgent sa = (SensorAgent)myAgent;
