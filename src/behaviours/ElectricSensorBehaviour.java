...
public class ElectricSensorBehaviour extends CyclicBehaviour
{
	...
	public void action()
	{
		System.out.println("Agentul responsabil de senzorul electric asteapta date");
			...
			switch (msg.getPerformative()) 
            {
               case (ACLMessage.INFORM ):
               {
            	   if ( action instanceof InterpretData )
            	   {
            		   ...
            		   // sensor type.
            		   ElectricSensor sensor = (ElectricSensor)((InterpretData) action).getSensor();
	...
	protected boolean isDataValid( ElectricSensor sensor )
	{
...
//			return false;
	...
	protected String interpretData( ElectricSensor sensor )
	{
	...
	protected void handleSensorData(ElectricSensor sensor)
	{
		//validate data
		SensorAgent sa = (SensorAgent)myAgent;
